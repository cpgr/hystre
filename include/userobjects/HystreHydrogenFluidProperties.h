 ...
 */
class HystreHydrogenFluidProperties : public HystreHelmholtzFluidProperties
{
public:
  static InputParameters validParams();

  HystreHydrogenFluidProperties(const InputParameters & parameters);

  virtual std::string fluidName() const override;

  virtual Real molarMass() const override;

  virtual Real mu_from_rho_T(Real rho, Real T) const override;
  ...
  virtual void rho_mu_from_p_T(Real p, Real T, Real & rho, Real & mu) const override;
  ...
  virtual Real k_from_rho_T(Real rho, Real T) const override;
  ...
  virtual Real vaporPressure(Real T) const override;

  virtual void vaporPressure(Real T, Real & psat, Real & dpsat_dT) const override;

protected:
  virtual Real alpha0(Real delta, Real tau) const override;

  virtual Real dalpha0_ddelta(Real delta, Real tau) const override;

  virtual Real dalpha0_dtau(Real delta, Real tau) const override;

  virtual Real d2alpha0_ddelta2(Real delta, Real tau) const override;

  virtual Real d2alpha0_dtau2(Real delta, Real tau) const override;

  virtual Real d2alpha0_ddeltatau(Real delta, Real tau) const override;

  virtual Real alphar(Real delta, Real tau) const override;

  virtual Real dalphar_ddelta(Real delta, Real tau) const override;

  virtual Real dalphar_dtau(Real delta, Real tau) const override;

  virtual Real d2alphar_ddelta2(Real delta, Real tau) const override;

  virtual Real d2alphar_dtau2(Real delta, Real tau) const override;

  virtual Real d2alphar_ddeltatau(Real delta, Real tau) const override;
