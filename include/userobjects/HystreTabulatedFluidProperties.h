 ...
 */
class HystreTabulatedFluidProperties : public HystreSinglePhaseFluidProperties
{
public:
  static InputParameters validParams();

  HystreTabulatedFluidProperties(const InputParameters & parameters);
  virtual ~HystreTabulatedFluidProperties();
...
protected:
  ...
  const HystreSinglePhaseFluidProperties & _fp;
