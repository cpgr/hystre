...
DualReal
HystreSinglePhaseFluidProperties::vaporPressure(const DualReal & T) const
{
  Real p = 0.0;
...
DualReal
HystreSinglePhaseFluidProperties::vaporTemperature(const DualReal & p) const
{
  Real T = 0.0;
...
void
HystreSinglePhaseFluidProperties::rho_mu_from_p_T(const DualReal & p,
                                                  const DualReal & T,
                                                  DualReal & rho,
                                                  DualReal & mu) const
{
